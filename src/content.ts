...
export const COPY: Record<Locale, LandingCopy> = {
  en: {
    ...
    homeLabel: "Make Agent Fast home",
    navDemo: "Demo",
    navHow: "How it works",
    navFaq: "FAQ",
    navLabel: "Main navigation",
    headerCta: "View the demo",
    languageLabel: "Interface language",
    themeLabel: "Change color theme",
    openMenuLabel: "Open navigation",
    closeMenuLabel: "Close navigation",
    onlineLabel: "Simulated online status",
    ...
    cta: "View local examples",
    examplesLabel: "Static example customer conversations",
    ...
    faqs: [
      {
        ...
        answer: "Make Agent Fast 랜딩 경험과 로컬 인터페이스 상태를 보여 주는, 실제로 작동하는 프런트엔드 전용 페이지입니다.",
      },
      {
  ...
  uz: {
    brand: "Make Agent Fast",
    homeLabel: "Make Agent Fast bosh sahifasi",
    navDemo: "Demo",
    navHow: "Qanday ishlaydi",
    navFaq: "Savol-javob",
    navLabel: "Asosiy navigatsiya",
    headerCta: "Demoni koʻrish",
    languageLabel: "Interfeys tili",
    themeLabel: "Rang mavzusini oʻzgartirish",
    openMenuLabel: "Navigatsiyani ochish",
    closeMenuLabel: "Navigatsiyani yopish",
    onlineLabel: "Namunaviy onlayn holat",
    skipLabel: "Asosiy qismga oʻtish",
    eyebrow: "Mijozlarga xizmat koʻrsatish — yanada sodda",
    title: ["BITTA AGENT.", "BARCHA KANALLAR.", "MIJOZLARINGIZ BILAN SUHBATLASHADI."],
    lede: "Make Agent Fast bir necha daqiqada, kod yozmasdan mijozlarga xizmat koʻrsatish agentini yaratadi.",
    cta: "Mahalliy namunalarni koʻrish",
    examplesLabel: "Mijozlar bilan statik suhbat namunalari",
    howEyebrow: "Oddiy jarayon",
    howTitle: "Tasdiqlangan maʼlumotdan foydali suhbatgacha.",
    journeyNote: "Uch bosqichli aniq yoʻl birinchi manbadan yakuniy javobgacha boʻlgan jarayonni tushunarli qiladi.",
    previewLabel: "Javob namunasi",
    previews: [
      {
        prompt: "Boshlashdan oldin nimalarni tayyorlashim kerak?",
        answer: "Avval mijozlaringiz eng koʻp soʻraydigan ochiq maʼlumotlarni toʻplang.",
        source: "Toʻplash · Tasdiqlangan maʼlumot",
      },
      {
        prompt: "Javoblar jamoamiz uslubida boʻlishi mumkinmi?",
      ...
      },
      {
        ...
        answer: "Tanlagan mijozlar kanalida koʻrinadigan kirish nuqtasini joylashtiring.",
    ...
    rolesNote: "Bir nechta odatiy rolni almashtirib, ayni landing tajribasi mijozlarning turli ehtiyojlarini qanday ajratib koʻrsatishini koʻring.",
    ...
    roles: [
      {
        ...
        description: "Tasdiqlangan qoʻllanmalarni tartiblab, koʻp beriladigan savollarga izchil javob bering.",
        tasks: ["Ochiq qoidalarni tushuntirish", "Foydali qoʻllanmaga yoʻnaltirish", "Mutaxassis uchun xulosa tayyorlash"],
      },
      {
        name: "Savdo",
        kicker: "Maqsadli va foydali",
        title: "Dastlabki savollarni yaxshiroq tanishuvga aylantiring.",
        description: "Yangi tashrif buyuruvchini ortiqcha maʼlumot bilan chalgʻitmasdan, kerakli ochiq mahsulot maʼlumotini koʻrsating.",
        tasks: ["Mavjud variantlarni tushuntirish", "Moslik savollariga javob berish", "Keyingi soʻrovni yozib olish"],
      },
      {
        name: "Jarayonlar",
        kicker: "Toʻgʻridan-toʻgʻri va tartibli",
        title: "Kundalik maʼlumotlarni oson topiladigan qiling.",
        description: "Koʻp soʻraladigan ochiq maʼlumotlarni bitta qulay suhbatga jamlang.",
        tasks: ["Ish vaqtini koʻrsatish", "Asosiy jarayonlarni tushuntirish", "Kerakli manbaga yoʻnaltirish"],
      },
    ],
    faqEyebrow: "Bilish foydali",
    faqTitle: "Chegaralari aniq, yoʻnaltirilgan namuna.",
    faqs: [
      {
        question: "Ushbu ommaviy sahifada nimalar bor?",
        answer: "Bu Make Agent Fast landing sahifasi va uning mahalliy interfeys holatlarini koʻrsatadigan, faqat frontenddan iborat ishlaydigan namoyish.",
      },
      {
        question: "Bu demo haqiqiy xizmatga ulanadimi?",
        answer: "Yoʻq. Suhbat namunalari, rol tanlash tugmalari, til va rang rejimi faqat brauzerda ishlaydi.",
      },
      {
        question: "Toʻliq mahsulot shu yerda ochiqmi?",
        answer: "Yoʻq. Toʻliq mahsulot va uning ommaga ochilmagan tizimlari alohida saqlanadi.",
      },
    ],
    footerNote: "Make Agent Fast ochiq landing sahifasining bir qismi.",
    backToTop: "Yuqoriga qaytish",
    steps: [
      "Mijozlarga kerak boʻladigan ochiq maʼlumotlarni toʻplang.",
      "Ohangni belgilang va koʻp beriladigan savollarni sinang.",
    ...
    conversations: [
      {
        ...
        answer: "Ha. Tasdiqlangan maʼlumotlarni ulashing, agent tashrif buyuruvchilarni yoʻnaltiradi.",
      },
      {
        channel: "CHAT",
      ...
      },
      {
        ...
        question: "Mutaxassis bilan gaplashsam boʻladimi?",
        answer: "Albatta. Jamoaga yetkazish uchun soʻrovingizni yozib olaman.",
      },
      {
        channel: "EMAIL",
        name: "Pochta yordamchisi",
        question: "Sozlash qoʻllanmasini qayerdan topsam boʻladi?",
        answer: "Kerakli ochiq qoʻllanmani topib, dastlabki qadamlarni qisqacha aytib beraman.",
      },
      {
        channel: "IJTIMOIY",
        name: "Hamjamiyat yordamchisi",
        question: "Bu kichik jamoalar uchun ham mosmi?",
        answer: "Ha. Xuddi shu ixcham tajribani kichik maʼlumotlar toʻplamidan boshlash mumkin.",
      },
    ],
  },
};
